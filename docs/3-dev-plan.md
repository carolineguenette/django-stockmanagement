...
| Étape       | Description                                                                                                                                                                                                                        |
| ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.1 POC     | Proof of Concept testant l'architecture company-scoped : contexte compagnie courant, filtrage automatique des données, règles propriétaires/employés et isolation des accès par entreprise                                         |
...
Pour ce projet portfolio, j'ai mis en place une gestion sous Jira en combinant une approche par Versions et des Sprints axés sur des livrables fonctionnels. Je l'utilise notamment pour estimer la charge de travail et analyser le ratio temps estimé vs temps réel passé. Le tout est ouvert au public en consultation.
