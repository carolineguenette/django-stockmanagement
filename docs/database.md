...
### ![](https://img.shields.io/badge/-Model-blue.svg) Setting (table `core_setting`)
...
| default_currency                                       | ![](https://img.shields.io/badge/DEV-VX-green.svg) Sert de référence monétaire globale pour l'ensemble de l'application et donc toutes les compagnies et leurs locations. |

## <a id=""> ![](https://img.shields.io/badge/-App-darkblue.svg) Users
