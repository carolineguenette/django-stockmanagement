...
| 3.users.userrolelog.view                                                                 | Voir l'historique des modifications sur les assignations de rôle.<br/><br/>*Un utilisateur avec cette permission ne peut voir les informations  concernant que ses subordonnés.*                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | SYSTEM   | MEDIUM      |
